...
use stubbles\helper\rss\annotationbased\ExtendedRSSItemEntity;
use stubbles\helper\rss\annotationbased\MissingAllRssItemEntity;
use stubbles\helper\rss\annotationbased\MissingDescriptionRssItemEntity;
use stubbles\helper\rss\annotationbased\MissingLinkAndDescriptionRssItemEntity;
use stubbles\helper\rss\annotationbased\RssItemWithDifferentMethods;
use stubbles\helper\rss\annotationbased\SimpleRssItemEntity;
...
#[Group('xml')]
#[Group('xml_rss')]
class RssFeedItemFromEntityAnnotationBasedTest extends TestCase
{
